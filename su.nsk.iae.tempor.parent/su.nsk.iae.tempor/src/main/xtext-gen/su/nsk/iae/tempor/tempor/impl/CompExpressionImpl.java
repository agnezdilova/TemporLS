 ...
 * </p>
 * <ul>
 *   <li>{@link su.nsk.iae.tempor.tempor.impl.CompExpressionImpl#getCompOp <em>Comp Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompExpressionImpl extends AndExpressionImpl implements CompExpression
{
  ...
  {
    return TemporPackage.Literals.COMP_EXPRESSION;
  }
  ...
  public void setCompOp(CompOperator newCompOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TemporPackage.COMP_EXPRESSION__COMP_OP, oldCompOp, compOp));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TemporPackage.COMP_EXPRESSION__COMP_OP:
        return getCompOp();
    }
