 ...
 * </p>
 * <ul>
 *   <li>{@link su.nsk.iae.tempor.tempor.impl.TrigImpl#getName <em>Name</em>}</li>
 *   <li>{@link su.nsk.iae.tempor.tempor.impl.TrigImpl#getInvariant <em>Invariant</em>}</li>
 *   <li>{@link su.nsk.iae.tempor.tempor.impl.TrigImpl#getRelease_reaction <em>Release reaction</em>}</li>
 *   <li>{@link su.nsk.iae.tempor.tempor.impl.TrigImpl#getDelay_final <em>Delay final</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TrigImpl extends MinimalEObjectImpl.Container implements Trig
{
  ...
  {
    return TemporPackage.Literals.TRIG;
  }
    ...
    if (name != null && name.eIsProxy())
    {
      ...
      if (name != oldName)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, TemporPackage.TRIG__NAME, oldName, name));
      }
    }
    return name;
  }
  ...
  public void setName(SentenceDeclaration newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TemporPackage.TRIG__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetInvariant(Inv newInvariant, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TemporPackage.TRIG__INVARIANT, oldInvariant, newInvariant);
  ...
  public void setInvariant(Inv newInvariant)
  {
    if (newInvariant != invariant)
    {
      ...
      if (invariant != null)
        msgs = ((InternalEObject)invariant).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemporPackage.TRIG__INVARIANT, null, msgs);
      if (newInvariant != null)
        msgs = ((InternalEObject)newInvariant).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemporPackage.TRIG__INVARIANT, null, msgs);
      msgs = basicSetInvariant(newInvariant, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TemporPackage.TRIG__INVARIANT, newInvariant, newInvariant));
  }
  ...
  public NotificationChain basicSetRelease_reaction(RelRea newRelease_reaction, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TemporPackage.TRIG__RELEASE_REACTION, oldRelease_reaction, newRelease_reaction);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setRelease_reaction(RelRea newRelease_reaction)
  {
    if (newRelease_reaction != release_reaction)
    {
      ...
      if (release_reaction != null)
        msgs = ((InternalEObject)release_reaction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemporPackage.TRIG__RELEASE_REACTION, null, msgs);
      if (newRelease_reaction != null)
        msgs = ((InternalEObject)newRelease_reaction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemporPackage.TRIG__RELEASE_REACTION, null, msgs);
      msgs = basicSetRelease_reaction(newRelease_reaction, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TemporPackage.TRIG__RELEASE_REACTION, newRelease_reaction, newRelease_reaction));
  }
  ...
  public NotificationChain basicSetDelay_final(DelFin newDelay_final, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TemporPackage.TRIG__DELAY_FINAL, oldDelay_final, newDelay_final);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDelay_final(DelFin newDelay_final)
  {
    if (newDelay_final != delay_final)
    {
      NotificationChain msgs = null;
      if (delay_final != null)
        msgs = ((InternalEObject)delay_final).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemporPackage.TRIG__DELAY_FINAL, null, msgs);
      if (newDelay_final != null)
        msgs = ((InternalEObject)newDelay_final).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemporPackage.TRIG__DELAY_FINAL, null, msgs);
      msgs = basicSetDelay_final(newDelay_final, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TemporPackage.TRIG__DELAY_FINAL, newDelay_final, newDelay_final));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TemporPackage.TRIG__INVARIANT:
        return basicSetInvariant(null, msgs);
      case TemporPackage.TRIG__RELEASE_REACTION:
        return basicSetRelease_reaction(null, msgs);
      case TemporPackage.TRIG__DELAY_FINAL:
