 ...
 * </p>
 * <ul>
 *   <li>{@link su.nsk.iae.tempor.tempor.impl.SentDeclarationImpl#getDeclarationName <em>Declaration Name</em>}</li>
 *   <li>{@link su.nsk.iae.tempor.tempor.impl.SentDeclarationImpl#getSentenceDeclaration <em>Sentence Declaration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SentDeclarationImpl extends MinimalEObjectImpl.Container implements SentDeclaration
{
  ...
  {
    return TemporPackage.Literals.SENT_DECLARATION;
  }
  ...
  public void setDeclarationName(String newDeclarationName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TemporPackage.SENT_DECLARATION__DECLARATION_NAME, oldDeclarationName, declarationName));
  }
  ...
  public NotificationChain basicSetSentenceDeclaration(SentenceDeclaration newSentenceDeclaration, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TemporPackage.SENT_DECLARATION__SENTENCE_DECLARATION, oldSentenceDeclaration, newSentenceDeclaration);
  ...
  public void setSentenceDeclaration(SentenceDeclaration newSentenceDeclaration)
  {
    if (newSentenceDeclaration != sentenceDeclaration)
    {
      ...
      if (sentenceDeclaration != null)
        msgs = ((InternalEObject)sentenceDeclaration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemporPackage.SENT_DECLARATION__SENTENCE_DECLARATION, null, msgs);
      if (newSentenceDeclaration != null)
        msgs = ((InternalEObject)newSentenceDeclaration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemporPackage.SENT_DECLARATION__SENTENCE_DECLARATION, null, msgs);
      msgs = basicSetSentenceDeclaration(newSentenceDeclaration, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TemporPackage.SENT_DECLARATION__SENTENCE_DECLARATION, newSentenceDeclaration, newSentenceDeclaration));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TemporPackage.SENT_DECLARATION__SENTENCE_DECLARATION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TemporPackage.SENT_DECLARATION__DECLARATION_NAME:
