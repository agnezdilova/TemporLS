 ...
 * </p>
 * <ul>
 *   <li>{@link su.nsk.iae.tempor.tempor.impl.Inv_alwaysImpl#getInv <em>Inv</em>}</li>
 *   <li>{@link su.nsk.iae.tempor.tempor.impl.Inv_alwaysImpl#getRelease_reaction <em>Release reaction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Inv_alwaysImpl extends MinimalEObjectImpl.Container implements Inv_always
{
  ...
  {
    return TemporPackage.Literals.INV_ALWAYS;
  }
    ...
    if (inv != null && inv.eIsProxy())
    {
      ...
      if (inv != oldInv)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, TemporPackage.INV_ALWAYS__INV, oldInv, inv));
      }
    }
    return inv;
  }
  ...
  public void setInv(SentenceDeclaration newInv)
  {
    ...
    inv = newInv;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TemporPackage.INV_ALWAYS__INV, oldInv, inv));
  }
  ...
  public NotificationChain basicSetRelease_reaction(RelRea newRelease_reaction, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TemporPackage.INV_ALWAYS__RELEASE_REACTION, oldRelease_reaction, newRelease_reaction);
  ...
  public void setRelease_reaction(RelRea newRelease_reaction)
  {
    if (newRelease_reaction != release_reaction)
    {
      ...
      if (release_reaction != null)
        msgs = ((InternalEObject)release_reaction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemporPackage.INV_ALWAYS__RELEASE_REACTION, null, msgs);
      if (newRelease_reaction != null)
        msgs = ((InternalEObject)newRelease_reaction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemporPackage.INV_ALWAYS__RELEASE_REACTION, null, msgs);
      msgs = basicSetRelease_reaction(newRelease_reaction, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TemporPackage.INV_ALWAYS__RELEASE_REACTION, newRelease_reaction, newRelease_reaction));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TemporPackage.INV_ALWAYS__RELEASE_REACTION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TemporPackage.INV_ALWAYS__INV:
