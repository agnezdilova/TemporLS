 ...
 * </p>
 * <ul>
 *   <li>{@link su.nsk.iae.tempor.tempor.impl.DeclVarInputImpl#getVarDecls <em>Var Decls</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeclVarInputImpl extends MinimalEObjectImpl.Container implements DeclVarInput
{
  ...
  {
    return TemporPackage.Literals.DECL_VAR_INPUT;
  }
  ...
  public EList<VarDeclaration> getVarDecls()
  {
    if (varDecls == null)
    {
      varDecls = new EObjectContainmentEList<VarDeclaration>(VarDeclaration.class, this, TemporPackage.DECL_VAR_INPUT__VAR_DECLS);
    }
    return varDecls;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TemporPackage.DECL_VAR_INPUT__VAR_DECLS:
