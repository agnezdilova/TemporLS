 ...
 * </p>
 * <ul>
 *   <li>{@link su.nsk.iae.tempor.tempor.impl.InvImpl#getInv <em>Inv</em>}</li>
 *   <li>{@link su.nsk.iae.tempor.tempor.impl.InvImpl#getDelay_final <em>Delay final</em>}</li>
 *   <li>{@link su.nsk.iae.tempor.tempor.impl.InvImpl#getRelease_reaction <em>Release reaction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InvImpl extends MinimalEObjectImpl.Container implements Inv
{
  ...
  {
    return TemporPackage.Literals.INV;
  }
    ...
    if (inv != null && inv.eIsProxy())
    {
      ...
      if (inv != oldInv)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, TemporPackage.INV__INV, oldInv, inv));
      }
    }
    return inv;
  }
  ...
  public void setInv(SentenceDeclaration newInv)
  {
    ...
    inv = newInv;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TemporPackage.INV__INV, oldInv, inv));
  }
  ...
  public NotificationChain basicSetDelay_final(DelFin newDelay_final, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TemporPackage.INV__DELAY_FINAL, oldDelay_final, newDelay_final);
  ...
  public void setDelay_final(DelFin newDelay_final)
  {
    if (newDelay_final != delay_final)
    {
      ...
      if (delay_final != null)
        msgs = ((InternalEObject)delay_final).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemporPackage.INV__DELAY_FINAL, null, msgs);
      if (newDelay_final != null)
        msgs = ((InternalEObject)newDelay_final).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemporPackage.INV__DELAY_FINAL, null, msgs);
      msgs = basicSetDelay_final(newDelay_final, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TemporPackage.INV__DELAY_FINAL, newDelay_final, newDelay_final));
  }
  ...
  public NotificationChain basicSetRelease_reaction(RelRea newRelease_reaction, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TemporPackage.INV__RELEASE_REACTION, oldRelease_reaction, newRelease_reaction);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setRelease_reaction(RelRea newRelease_reaction)
  {
    if (newRelease_reaction != release_reaction)
    {
      ...
      if (release_reaction != null)
        msgs = ((InternalEObject)release_reaction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemporPackage.INV__RELEASE_REACTION, null, msgs);
      if (newRelease_reaction != null)
        msgs = ((InternalEObject)newRelease_reaction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemporPackage.INV__RELEASE_REACTION, null, msgs);
      msgs = basicSetRelease_reaction(newRelease_reaction, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TemporPackage.INV__RELEASE_REACTION, newRelease_reaction, newRelease_reaction));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TemporPackage.INV__DELAY_FINAL:
        return basicSetDelay_final(null, msgs);
      case TemporPackage.INV__RELEASE_REACTION:
