...
import su.nsk.iae.tempor.tempor.CompOperator;
...
import su.nsk.iae.tempor.tempor.EquOperator;
...
import su.nsk.iae.tempor.tempor.TemporFactory;
...
public class TemporPackageImpl extends EPackageImpl implements TemporPackage
{
   ...
   * @see su.nsk.iae.tempor.tempor.TemporPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   */
  @Override
  public EReference getDelFin_Delay()
  {
    return (EReference)delFinEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getDelFin_Fin()
  {
    return (EReference)delFinEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EAttribute getDelFin_Imm()
  {
    return (EAttribute)delFinEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
  @Override
  public EReference getDelay_Del()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(delFinEClass, DEL_FIN__DELAY);
    createEReference(delFinEClass, DEL_FIN__FIN);
    createEAttribute(delFinEClass, DEL_FIN__IMM);

    delayEClass = createEClass(DELAY);
    createEReference(delayEClass, DELAY__DEL);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getRelRea_Reaction(), this.getRea(), null, "reaction", null, 0, 1, RelRea.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDelFin_Delay(), this.getDelay(), null, "delay", null, 0, 1, DelFin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDelFin_Fin(), this.getSentenceDeclaration(), null, "fin", null, 0, 1, DelFin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDelFin_Imm(), ecorePackage.getEBoolean(), "imm", null, 0, 1, DelFin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(delayEClass, Delay.class, "Delay", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getDelay_Del(), this.getSentenceDeclaration(), null, "del", null, 0, 1, Delay.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
