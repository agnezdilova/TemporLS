 ...
 * </p>
 * <ul>
 *   <li>{@link su.nsk.iae.tempor.tempor.impl.EquExpressionImpl#getEquOp <em>Equ Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EquExpressionImpl extends CompExpressionImpl implements EquExpression
{
  ...
  {
    return TemporPackage.Literals.EQU_EXPRESSION;
  }
  ...
  public void setEquOp(EquOperator newEquOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TemporPackage.EQU_EXPRESSION__EQU_OP, oldEquOp, equOp));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TemporPackage.EQU_EXPRESSION__EQU_OP:
        return getEquOp();
    }
